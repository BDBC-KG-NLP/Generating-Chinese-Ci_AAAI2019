...
train_arg.add_argument('--is_vowel_tone', type=str, default='NONE', choices=['NONE', 'ALL', 'YUNJIAO'])
train_arg.add_argument('--vowel_tone_input', type=str, default='NONE', choices=['NONE', 'DEC_RNN', 'PROJECTION', 'VOWEL_GRU_TONE_PROJECTION'])
