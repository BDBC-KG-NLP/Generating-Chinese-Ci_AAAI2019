...
class Iterator(object):
    ...
    def get_one_info(self, cipai,is_train:bool=True) -> Tuple[Dict[str, List], Dict[str, List], List]:
        r"""next
        ...
        yunjiao_list = []
        key = cipai
        index_list = self._key_holder[key]
